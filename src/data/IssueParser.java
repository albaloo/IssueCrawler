...
public class IssueParser{
    ...
    public void parseIssue(IssueInfo issue, String filePath, String SUFFIX) throws IOException{
		...
		if (issue.getNumPages() > 1) {
			threadFile = new File("C:\\Users\\rzilouc2\\Documents\\Research\\PhD-repository\\Prelim\\Implementation\\IssueSaver\\thread-" + IssueQueueParser.FindIssueNameFromPartialLink(issue.getLink()) +SUFFIX +"-p2.txt");
